...
export default function About() {
  return (
    <>
      <IonHeader>
        <IonToolbar>{/* <IonTitle>Create Order</IonTitle> */}</IonToolbar>
      </IonHeader>
      <IonContent className="ion-padding">
        ...
        <ul>
          <li>
            <strong>Order Management:</strong> 📋 Effortlessly organize and keep
            track of customer orders received via WhatsApp and in-house dining.
            Say goodbye to order chaos in your restaurant. 🚀
          </li>
          <li>
